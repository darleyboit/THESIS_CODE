...
# opening patent data
uspatent <- read_csv("data_cleaned/only_half_clean/uspatent.csv") |>
  mutate(filing_date = substr(filing_date, 1, 4)) |>
  select(appln_id, filing_date, name_2, name_1)
#renaming columns  
colnames(uspatent) <- c("appln_id", "year", "county", "state")
...
cleanpatent <- bind_rows(alpatent, akpatent, azpatent, arpatent, capatent, copatent, ctpatent, depatent, flpatent, gapatent, hipatent, idpatent, ilpatent, inpatent, iopatent, kspatent, kypatent, lapatent, mepatent, mdpatent, mapatent, mipatent, mnpatent, mspatent, mopatent, mtpatent, nepatent, nvpatent, nhpatent, njpatent, nmpatent, nypatent, nhpatent, ncpatent, ndpatent, ohpatent, okpatent, orpatent, papatent, ripatent, scpatent, sdpatent, tnpatent, txpatent, utpatent, vtpatent, vapatent, wapatent, wvpatent, wipatent, wypatent)
...
library(writexl)
write_xlsx(cleanpatent, path = "data_cleaned/countylevel_patent.xlsx")
